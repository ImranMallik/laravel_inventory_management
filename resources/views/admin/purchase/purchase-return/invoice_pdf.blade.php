    ...
    <div class="invoice-container">
        ...
        <table class="info-section">
            <tr>
                <td class="info-box">
                    <h5>Supplier Info</h5>
                    <p><strong>Name:{{ $returnparchase->supplier->name }}</strong> </p>
                    <p><strong>Email: {{ $returnparchase->supplier->email }}</strong> </p>
                    <p><strong>Phone:{{ $returnparchase->supplier->phone }}</strong> </p>
                </td>
                <td class="info-box">
                    <h5>Warehouse</h5>
                    <p> {{ $returnparchase->warehouse->name }}</p>
                </td>
                <td class="info-box">
                    <h5>Purchase Info</h5>
        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($returnparchase->return_purchase_items as $key => $item)
                    <tr>
                        <td> {{ $key + 1 }}</td>
